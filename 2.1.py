...
╚════════════════════╝                            """)
    ...
    url = input("\033[97m[\033[93m*\033[97m] \033[1;96mĐịa chỉ URL\033[0m: ").strip()
    duration = int(input("\033[97m[\033[93m*\033[97m] \033[1;96mThời gian\033[0m (\033[1;92mGiây\033[0m): ").strip())
    threads_count = int(input("\033[97m[\033[93m*\033[97m] \033[1;96mSố lượng luồng\033[0m: ").strip())
